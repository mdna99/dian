...
$file_db = 'ucapan_tamu_boyong.json';
...
<body>
    <div id="mobile-frame">
        ...
        <div id="cover">
            <h5 class="mb-3 text-uppercase" style="letter-spacing: 3px;">Boyong Temanten</h5>
            <h1 class="cursive mb-4">Dian Nafi' & Elly</h1>
        ...
        <div id="main-scroll">
            ...
            <section id="home" class="section d-flex flex-column overflow-hidden"
                ...
                <div class="text-center d-flex flex-column justify-content-center align-items-center px-3 pt-5 pb-2 position-relative"
                    ...
                    <h2 class="serif position-relative" style="z-index: 1;" data-aos="fade-up"><strong>Boyong Temanten</strong></h2>
                    ...
                    <h1 class="cursive text-mocca position-relative pt-5" style="z-index: 1;" data-aos="fade-up" data-aos-duration="1000"><strong>Dian Nafi' & Elly</strong></h1>
                    <p class="lead fw-bold position-relative" style="z-index: 1;" data-aos="fade-up" data-aos-delay="400">Minggu, 19 April 2026</p>
            ...
            <section id="event" class="section">
                <div class="card-custom-pill shadow-custom rounded-pill text-center">
                    ...
                    <div class="mb-4" data-aos="fade-up" data-aos-delay="100">
                        <h5 class="fw-bold"><i class="fas fa-ring me-2"></i>Boyong Temanten</h5>
                    </div>
                    <hr class="w-50 mx-auto" data-aos="zoom-in" data-aos-delay="200">
                    <p class="small" data-aos="fade-up" data-aos-delay="300">Pukul 09.00 WIB - Selesai <br> <strong>Minggu, 19 April 2026 </strong></p>
                    <p class="small" data-aos="fade-up" data-aos-delay="400">Kediaman Mempelai Pria <br> <strong>Sedahromo Kidul, RT 01 RW 09, Kartasura, Sukoharjo</strong></p>
                    <a href="https://maps.app.goo.gl/FphxGZM9t7NhihXa7" target="_blank" class="btn btn-mocca btn-sm" data-aos="fade-up" data-aos-delay="500">
                        <i class="fas fa-map-marker-alt me-1"></i> Lihat Lokasi
                    </a>
                    <div class="d-flex justify-content-center align-items-end position-relative" style="flex: 1;">
                        <img src="assets/FlowerUP.png" alt="Flower Dekorasi BottomFlower"
                            class="position-absolute" style="left: -10%; bottom: 0px; width: 120%; z-index: 1; pointer-events: none;">
                        <img src="assets/Element-13.png" alt="Element Dekorasi" class="position-relative"
                ...
                <div class="text-center d-flex flex-column justify-content-center align-items-center px-3 pb-2 position-relative" style="flex: 2;">
                    <div class="card-custom-rsvp text-center" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="text-dark d-flex justify-content-center flex-wrap gap-2 mb-3">
                            ...
                            <!-- Tombol WA -->
                            <a href="https://wa.me/62818780801?text=Halo%2C+saya+ingin+konfirmasi+pengiriman+hadiah+pernikahan+untuk+Dian+%26+Elly."
                                target="_blank"
                                class="btn btn-sm text-dark border-dark  d-inline-flex align-items-center gap-1 px-3 py-1"
                                style="background-color: transparent; font-size: 0.8rem;">
                            ...
                            <div class="text-white p-3 rounded-3" style="background: rgba(0,0,0,0.4);">
                                ...
                                <div class="text-start border border-light rounded p-2 mb-2">
                                    ...
                                    <p class="mb-0" style="font-size: 0.75rem;">
                                        <span class="fw-semibold">Nama Penerima : M. Dian Nafi' Aziz</span> <br> Sedahromo Kidul, RT 01 RW 09, Kartasura, Sukoharjo<br>
                                        <i class="bi bi-whatsapp me-1"></i> +62 818 7808 01
                                    </p>
                                </div>
            ...
            <section id="thanks" class="section d-flex flex-column overflow-hidden"
                ...
                <div class="text-center d-flex flex-column justify-content-center align-items-center px-3 pt-5 pb-2 position-absolute"
                    ...
                    <div class="mt-2 px-2" style="max-width: 560px;">
                        ...
                        <p class="small" data-aos="fade-up" data-aos-delay="200"><strong>Dian Nafi' & Elly</strong></p>
                    </div>
                </div>
    ...
    <script>
        ...
        const target = new Date("April 19, 2026 09:00:00").getTime();
        setInterval(() => {
