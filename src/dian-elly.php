        ...
        <div id="main-scroll">
            ...
            <section id="home" class="section d-flex flex-column overflow-hidden"
                ...
                <div class="text-center d-flex flex-column justify-content-center align-items-center px-3 pt-5 pb-2 position-relative"
                    ...
                    <h2 class="serif position-relative" style="z-index: 1;"><strong>Boyong Temanten</strong></h2>
                    ...
                    <h1 class="cursive text-mocca position-relative pt-5" style="z-index: 1;"><strong>Dian Nafi' & Elly</strong></h1>
                    <p class="lead fw-bold position-relative" style="z-index: 1;">Minggu, 19 April 2026</p>
            ...
            <section id="event" class="section">
                <div class="card-custom-pill shadow-custom rounded-pill text-center">
                    ...
                    <p class="small">Pukul 09.00 WIB - Selesai <br> <strong>Minggu, 19 April 2026 </strong></p>
                    <p class="small">Kediaman Mempelai Pria <br> <strong>Sedahromo Kidul, RT 01 RW 09, Kartasura, Sukoharjo</strong></p>
                    <a href="https://maps.app.goo.gl/FphxGZM9t7NhihXa7" target="_blank" class="btn btn-mocca btn-sm">
            ...
            <section id="thanks" class="section d-flex flex-column overflow-hidden"
                ...
                <div class="text-center d-flex flex-column justify-content-center align-items-center px-3 pt-5 pb-2 position-absolute"
                    ...
                    <div class="mt-2 px-2" style="max-width: 560px;">
                        ...
                        <p class="small"><strong>Dian Nafi' & Elly</strong></p>
                    </div>
                </div>
